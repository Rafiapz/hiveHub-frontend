...
import { deletePoll, editPoll, fetchUsersPolls, pollVote } from "../../service/api";
...
const UsersPoll = () => {
   ...
   const pollUserId = searchQuery.get("userId");
   ...
   const fetchPolls = async () => {
      try {
         const response = await fetchUsersPolls(pollUserId);
